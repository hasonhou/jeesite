...
<script type="text/javascript">include('ckeditor_lib','${ctxStatic}/ckeditor4/',['ckeditor.js']);</script>
<script type="text/javascript">
	...
	${replace}Ckeditor.config.removePlugins = 'elementspath';  //去掉底部P标签的显示
	${replace}Ckeditor.config.enterMode = CKEDITOR.ENTER_BR; //换行时以<br/>标签分割
	${replace}Ckeditor.config.shiftEnterMode = CKEDITOR.ENTER_BR;//换行时以<br/>标签分割
